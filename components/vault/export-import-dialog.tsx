...
import { decryptData, encryptData, generateIV, arrayBufferToBase64, base64ToUint8Array } from '@/lib/crypto/encryption';
      ...
      <DialogContent className="max-w-md border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <Tabs defaultValue="export" className="pt-4">
          ...
          <TabsContent value="import" className="space-y-4 mt-4">
            ...
            {importFile && (
              <div className="text-sm p-3 border-2 border-black bg-gray-50">
                <p className="font-bold">Selected: {importFile.name}</p>
                <p className="text-black/60">Size: {(importFile.size / 1024).toFixed(2)} KB</p>
              </div>
            )}
            ...
            <Button
              ...
              className="w-full bg-black text-white hover:bg-gray-800 border-2 border-black font-bold py-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all disabled:opacity-50"
            >
